...
device = torch.device("cuda:" + opt.gpu if opt.cuda else "cpu")
print(device)
...
plt.legend()
plt.show()
plt.savefig('%s/img/plots/losses_epoch_%03d.png' % (opt.outf,epoch))
...
plt.show()
plt.savefig('%s/img/samples/real_vs_fake_images_epoch_%03d.png' % (opt.outf,epoch))